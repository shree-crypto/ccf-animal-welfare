  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        default:
          "badge-default border-transparent text-primary-foreground",
        ...
        accent:
          "badge-accent border-transparent text-accent-foreground",
        // Success: Green badge
        success:
          "badge-success border-transparent text-white",
        // Warning: Orange/yellow badge
        warning:
          "badge-warning border-transparent text-white",
