  ...
  return (
    ...
    >
      ...
      <div className="relative group">
        <div
          className="absolute left-3 top-1/2 -translate-y-1/2 h-10 w-10 rounded-full bg-gradient-to-br from-purple-200 to-pink-200 dark:from-purple-800 dark:to-pink-800 flex items-center justify-center group-hover:scale-110 transition-transform"
          aria-hidden="true"
        >
