...
export const medicalRecordSchema = z.object({
  ...
  veterinarian: z.string().max(200, 'Veterinarian name must be less than 200 characters').optional(),
  medications: z.array(z.string().max(200, 'Medication name must be less than 200 characters')).optional(),
