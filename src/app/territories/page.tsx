          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Interactive map showing animal pack territories and locations
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm text-gray-600">
                <span className="font-medium">{territories.length}</span> territories
              </div>
            </div>
          </div>
        </div>
        ...
        {territories.length > 0 ? (
          ...
          <div className="h-full flex items-center justify-center bg-gray-50">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-lg mb-2">No territories found</p>
              <p className="text-gray-500 text-sm">
                Territories will appear here once they are added to the system.
              </p>
            </div>
          </div>
        )}
